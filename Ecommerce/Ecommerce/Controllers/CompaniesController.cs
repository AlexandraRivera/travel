...
namespace Ecommerce.Controllers
{
    public class CompaniesController : Controller
    {
        ...
        {
            var companies = db.Companies.Include(c => c.City).Include(c => c.Province);
        ...
        public ActionResult Create()
        {
            ...
            ViewBag.ProvinceId = new SelectList(CombosHelper.GetProvinces(), "ProvinceId", "Name");
            return View();
        }
        ...
        public ActionResult Create (Company company)
        {
            ...
            ViewBag.ProvinceId = new SelectList(CombosHelper.GetProvinces(), "ProvinceId", "Name", company.ProvinceId);
            return View(company);
        }
